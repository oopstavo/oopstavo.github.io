...
function init() {
  ...
  HEIGHT = document.getElementById('lion').clientHeight;
  WIDTH = document.getElementById('lion').clientWidth;
...
function loop() {
  ...
  var yTarget = mousePos.y - windowHalfY - 400;
